...
class FddHead(AnchorFreeHead):
    ...
    def _init_heads(self):
        ...
        # self.edge_cls = EdgeEnhancer1D(self.feat_channels)
    ...
    def forward_train(self, feat_list, mask_list, gt_segments, gt_labels, **kwargs):
        ...
        for l, (feat, mask) in enumerate(zip(feat_list, mask_list)):
            # feat, mask = self.edge_cls(feat, mask)
            cls_feat = feat
            reg_feat = feat
